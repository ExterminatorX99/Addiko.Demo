CREATE DATABASE [Demo]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Demo', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Demo.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Demo_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Demo_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
GO
...
GO
ALTER DATABASE [Demo] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
...
USE [Demo]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [Demo] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
